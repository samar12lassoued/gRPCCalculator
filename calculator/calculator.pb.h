...
PROTOBUF_NAMESPACE_OPEN
template <>
::sample::SampleRequest* Arena::CreateMaybeMessage<::sample::SampleRequest>(Arena*);
template <>
::sample::SampleResponse* Arena::CreateMaybeMessage<::sample::SampleResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class SampleRequest final :
 ...
 public:
  ...
  void set_request_sample_field(Arg_&& arg, Args_... args);
  std::string* mutable_request_sample_field();
  PROTOBUF_NODISCARD std::string* release_request_sample_field();
  void set_allocated_request_sample_field(std::string* ptr);

  private:
  const std::string& _internal_request_sample_field() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_request_sample_field(
...
class SampleResponse final :
 ...
 public:
  ...
  template <typename Arg_ = const std::string&, typename... Args_>
  void set_response_sample_field(Arg_&& arg, Args_... args);
  std::string* mutable_response_sample_field();
  PROTOBUF_NODISCARD std::string* release_response_sample_field();
  void set_allocated_response_sample_field(std::string* ptr);

  private:
  const std::string& _internal_response_sample_field() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_response_sample_field(
      const std::string& value);
...
inline PROTOBUF_ALWAYS_INLINE void SampleRequest::set_request_sample_field(Arg_&& arg,
                                                     Args_... args) {
  ;
  _impl_.request_sample_field_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
...
inline void SampleRequest::set_allocated_request_sample_field(std::string* value) {
  _impl_.request_sample_field_.SetAllocated(value, GetArenaForAllocation());
...
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void SampleResponse::set_response_sample_field(Arg_&& arg,
                                                     Args_... args) {
  ;
  _impl_.response_sample_field_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
...
inline void SampleResponse::set_allocated_response_sample_field(std::string* value) {
  _impl_.response_sample_field_.SetAllocated(value, GetArenaForAllocation());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
